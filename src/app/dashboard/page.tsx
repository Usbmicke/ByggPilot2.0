  ...
  return (
    ...
    <div className="flex flex-col gap-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <StatCard 
          icon={<Briefcase className="w-7 h-7 text-primary" />} // NY STIL: Ikon i primär accentfärg
        ...
        />
        <StatCard 
          icon={<Landmark className="w-7 h-7 text-primary" />} // Bättre ikon för intäkter
          title="Totala intäkter"
          value={stats.totalRevenue}
        />
      </div>

      {/* ---- "Call to Action"-sektion (HELT NY DESIGN) ---- */}
