...
// --- IKONER MED TYPER ---
const IconX: React.FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
);
const IconGavel: React.FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m14 12-8.5 8.5a2.12 2.12 0 1 1-3-3L11 9"></path><path d="m15 5 6 6"></path><path d="m9 11 8 8"></path></svg>
);
const IconTrendingUp: React.FC<SVGProps<SVGSVGElement>> = (props) => (
...
const IconMessageSquare: React.FC<SVGProps<SVGSVGElement>> = (props) => (
...
const IconShieldAlert: React.FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path><path d="M12 8v4"></path><path d="M12 16h.01"></path></svg>
);
const IconFileText: React.FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
);
const IconBookOpen: React.FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>
);
const IconClipboardCheck: React.FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><path d="m9 14 2 2 4-4"></path></svg>
);
const IconScale: React.FC<SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 16.5l4-4L14.5 8"></path><path d="M8 8.5l-4 4 5.5 4.5"></path><path d="M12 22V2"></path><path d="M5 12H2"></path><path d="M19 12h3"></path></svg>
);
export const IconLightbulb: React.FC<SVGProps<SVGSVGElement>> = (props) => (
        ...
        >
            ...
            >
                <div className="p-6 md:p-8 border-b border-gray-700 flex-shrink-0">
                    <button onClick={onClose} className="absolute top-4 right-4 text-gray-500 hover:text-white z-10 p-2 rounded-full hover:bg-gray-700/50"><IconX className="w-6 h-6" /></button>
                ...
                <div className="overflow-y-auto p-6 md:p-8">
                    <div className="flex flex-col gap-6">
                        ...
                        <TipCard className="" icon={<IconGavel className="w-6 h-6" />} title="Rätt avtal för rätt jobb – En snabbguide">
                        ...
                        <TipCard className="" icon={<IconMessageSquare className="w-6 h-6" />} title="Planering & Kommunikation – Din viktigaste investering">
                        ...
                        <TipCard className="" icon={<IconShieldAlert className="w-6 h-6" />} title="Riskhantering – Tänk steget längre än konkurrenterna">
                        ...
                        <TipCard className="" icon={<IconFileText className="w-6 h-6" />} title="Skriv ALLTID avtal – Skydda dig och din verksamhet">
                        ...
                        <TipCard className="" icon={<IconBookOpen className="w-6 h-6" />} title="Bli expert på din hemmabana – Utbilda dig med Boverket!">
                            <p>Boverket är myndigheten för byggande och boende. Deras hemsida är en guldgruva med gratis information som kan ge dig ett försprång genom att visa att du är uppdaterad på gällande byggregler (BBR).</p>
                             <ul className="list-disc list-inside pl-2 mt-3 space-y-2 text-gray-400">
                         ...
                         <TipCard className="" icon={<IconClipboardCheck className="w-6 h-6" />} title="Bygglov beviljat? Kom ihåg Startbesked!">
                         ...
                         <TipCard className="" icon={<IconScale className="w-6 h-6" />} title="Ritning vs. Beskrivning – Vad gäller vid en tvist?">
