...
import NextAuth, { getServerSession as originalGetServerSession, NextAuthOptions, DefaultSession } from 'next-auth';
    ...
    GoogleProvider({
      ...
      authorization: {
        params: {
          ...
          access_type: "offline",
          response_type: "code",
          scope: "https://www.googleapis.com/auth/drive.file openid https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email"
        }
      }
    }),
  ],
...
// Exporterar en korrekt konfigurerad version av getServerSession
