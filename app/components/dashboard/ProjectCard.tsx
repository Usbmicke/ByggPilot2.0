...
// **STEG 1: Importera de korrekta, centraliserade typerna**
import { Project, ProjectStatus } from '@/app/types';
import { IconSun, IconCloud, IconCloudRain, IconChevronDown, IconChevronUp, IconMoreHorizontal, IconUser } from '@/app/constants';
...
// **STEG 2: Korrigera statusColors-objektet**
// Nycklarna MÅSTE matcha värdena från ProjectStatus-enumet (t.ex. 'Anbud', 'Pågående').
...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, showWeather }) => {
    // **STEG 3: Robust fallback**
    // Om en okänd status skulle dyka upp, används en neutral grå färg.
    ...
    useEffect(() => {
        if (!showWeather || !project.lat || !project.lon) return;
