  ...
  const handleSignIn = async () => {
    try {
      if (login) {
        ...
        console.error("Login function is not available from AuthContext.");
      }
    } catch (error) {
          ...
          <section className="py-16 md:py-24">
            <div className="container mx-auto px-6 text-center">
                ...
                <div className="max-w-4xl mx-auto aspect-video bg-gray-800 border border-gray-700 rounded-lg flex items-center justify-center text-gray-500 overflow-hidden relative">
                  <Image src="/images/byggpilot.png" alt="Arbetsflödet i ByggPilot" fill sizes="(max-width: 896px) 100vw, 896px" style={{ objectFit: 'cover' }} />
                </div>
            </div>
          </section>
