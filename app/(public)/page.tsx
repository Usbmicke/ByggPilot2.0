          ...
          <section className="py-16 md:py-24">
            <div className="container mx-auto px-6 text-center">
                ...
                <div className="max-w-4xl mx-auto aspect-video bg-gray-800 border border-gray-700 rounded-lg flex items-center justify-center text-gray-500 overflow-hidden relative">
                    <Image src="/images/byggpilot.png" alt="Arbetsflödet i ByggPilot" fill className="object-cover" />
                </div>
            </div>
          </section>
                    ...
                    <div className="cursor-pointer group relative block bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_35px_rgba(233,213,128,0.3)] hover:border-yellow-300/50">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <h3 className="text-xl md:text-2xl font-bold text-white">Vässa ditt företag – Tips för proffs</h3>
                                    <p className="text-gray-400 max-w-2xl mt-1">En samling guider om allt från avtal och regler till hur du bygger starkare kundrelationer. Undvik fallgropar och arbeta mer professionellt.</p>
                                </div>
                            </div>
                            <div className="font-semibold text-white bg-gray-700/80 group-hover:bg-yellow-400/20 group-hover:text-yellow-200 transition-all rounded-md px-4 py-2">Öppna kunskapsbanken &rarr;</div>
                        </div>
                    </div>
                </div>
            </section>
